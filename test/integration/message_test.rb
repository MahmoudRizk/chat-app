...
class MessageTest < ActionDispatch::IntegrationTest
  ...
  test "Get messages with search" do
    application_id = "5839e194-5272-42dd-9fb6-157eb7be5e70"
    chat_id = "1"

    get "/applications/#{application_id}/chats/#{chat_id}/messages?search=first"
    assert_equal 200, status
    ...
    assert_equal('Application 1 Chat 1 first message', data[0]['name'])
